...
export default function WelcomePage() {
	...
	return (
		<View
			className="relative flex-1 bg-white dark:bg-black"
		...
		>
			...
			<View className="absolute inset-0 overflow-hidden" pointerEvents="none">
				...
				>
					<View className="h-[500px] w-[500px] rounded-full bg-gray-100 opacity-60 dark:bg-zinc-900/40" />
				</Animated.View>
				<Animated.View
					style={[
				...
				>
					<View className="h-[400px] w-[400px] rounded-full bg-gray-200/50 opacity-60 dark:bg-zinc-800/30" />
				</Animated.View>
			</View>

			<View className="z-10 flex-1 flex-col justify-between px-8">
				<View className="flex-row items-center justify-between pt-6">
					<Animated.View
						entering={FadeInDown.duration(600).easing(EasingStandard)}
					>
						<View className="h-10 w-10 items-center justify-center rounded-lg bg-black dark:bg-white">
							<Zap
								size={20}
					...
					<TouchableOpacity
						...
						className="py-2"
					>
						<Text className=" text-base font-medium tracking-wide text-gray-500 dark:text-gray-400">
							{t('welcome-skip')}
						</Text>
					</TouchableOpacity>
				</View>
				...
				<View className="-mt-10 flex-1 justify-center">
					...
					>
						<Text className="mb-6 text-4xl font-black leading-tight tracking-tighter text-black dark:text-white">
							{t('welcome-title')}
						</Text>
						<Text className="mb-12 max-w-[90%] text-lg leading-relaxed text-gray-500 dark:text-gray-400">
							{t('welcome-subtitle')}
						</Text>
					</Animated.View>
					<Animated.View
				...
				>
					<TouchableOpacity
						...
						activeOpacity={0.9}
						className="mb-6 h-16 w-full flex-row items-center justify-between rounded-none bg-black px-6 dark:bg-white"
						style={[
							{ borderRadius: 16 },
							Platform.select({
								ios: {
					...
					>
						<Text className="text-lg font-bold tracking-wide text-white dark:text-black">
	...
	return (
		<Animated.View className="flex items-start">
			<View className="flex-row items-center">
				<View className="mr-2 items-center justify-center rounded-lg bg-gray-200/50 p-1 dark:bg-zinc-800/30">
					{icon}
				</View>
				<Text className="ml-2 text-lg font-medium  tracking-tight text-gray-900 dark:text-gray-100">
					{title}
				</Text>
			</View>
		</Animated.View>
