	...
	return (
		...
		>
			...
			<View className="z-10 flex-1 flex-col justify-between px-8">
				<View className="flex-row items-center justify-end pt-6"></View>
				...
				>
					<View className="flex-row items-center" style={{ gap: 12 }}>
						<TouchableOpacity
							...
							activeOpacity={0.9}
							className="h-16 flex-row items-center justify-center rounded-2xl bg-gray-100 px-6 dark:bg-zinc-800"
							style={[
								{
						...
						>
							...
							<Text className="ml-2 text-lg font-medium tracking-wide text-gray-600 dark:text-gray-300">
								{t('intro-back') || '上一步'}
							</Text>
						</TouchableOpacity>
						<TouchableOpacity
							onPress={handleNext}
							activeOpacity={0.9}
							className="h-16 flex-1 flex-row items-center justify-center rounded-2xl bg-black px-6 dark:bg-white"
						>
